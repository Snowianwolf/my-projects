...
@app.route("/")
def home():
    return 'This is home page for no path, <h1> Remember me as a time of a day </h1>' 
...
@app.route('/error')
def error():
    return '<h1>Never let them take the light behind your eyes.</h1>'
...
def greet_admin():
    return redirect(url_for('greet', name='Captain Captain!!!'))
